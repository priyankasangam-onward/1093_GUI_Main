...
MODBUS_API int modbus_broadcast_mode(modbus_t *ctx, int addr, int nb, const uint16_t *src);

MODBUS_API int modbus_broadcast_write_single(modbus_t *ctx, int function, int addr, int value);
